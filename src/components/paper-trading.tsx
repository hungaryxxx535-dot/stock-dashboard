...
export function PaperTrading() {
  ...
  return <><header className="mb-6"><p className="mb-2 text-xs font-bold uppercase tracking-[.2em] text-cyan-600">Paper Broker</p><h1 className="text-3xl font-black tracking-tight sm:text-4xl">模拟委托台</h1><p className="mt-2 text-sm text-slate-500">只接受已通过计划状态机的 A 股计划；所有委托固定发送到本机 Paper Broker，不具备真实下单能力。</p></header>
